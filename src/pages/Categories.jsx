                        ...
                        <Col key={category.id} xs={12} sm={6} md={4}>
                            ...
                            >
                                ...
                                <div className="category-actions">
                                    <button className="category-trash" onClick={(e) => { e.stopPropagation(); deleteCategory(category.id); }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-3 -2 24 24" width="28" className="trash-icon" id="icon-trash">
                                    ...
                                    <button className="category-edit" onClick={(e) => { e.stopPropagation(); editCategory(category.id); }}>
